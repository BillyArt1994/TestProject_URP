...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class Tonemapping : VolumeComponent, IPostProcessComponent
    {
        ...
        // FILM
        public ClampedFloatParameter ACES_A = new ClampedFloatParameter(2.51f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.FILM"/> is active.
        public ClampedFloatParameter ACES_B = new ClampedFloatParameter(0.03f, 0.0f, 0.1f);
        /// This is only used when <see cref="Tonemapper.FILM"/> is active.
        public ClampedFloatParameter ACES_C = new ClampedFloatParameter(2.43f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.FILM"/> is active.
        public ClampedFloatParameter ACES_D = new ClampedFloatParameter(0.59f, 0f, 1.0f);
        /// This is only used when <see cref="Tonemapper.FILM"/> is active.
        public ClampedFloatParameter ACES_E = new ClampedFloatParameter(0.14f, 0f, 1.0f);

        // OverWatch2
        public ClampedFloatParameter A = new ClampedFloatParameter(2.51f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter B = new ClampedFloatParameter(0.03f, 0.0f, 0.1f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter C = new ClampedFloatParameter(2.43f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter D = new ClampedFloatParameter(0.59f, 0f, 1.0f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter E = new ClampedFloatParameter(0.14f, 0f, 1.0f);
        public ClampedFloatParameter F = new ClampedFloatParameter(2.51f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter G = new ClampedFloatParameter(0.03f, 0.0f, 0.1f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        public ClampedFloatParameter H = new ClampedFloatParameter(2.43f, 0f, 5.0f);
        /// This is only used when <see cref="Tonemapper.OverWatch2"/> is active.
        /// <inheritdoc/>
