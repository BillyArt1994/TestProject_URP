...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed partial class UniversalRenderer : ScriptableRenderer
    {
        ...
        internal SubstancePainterLookupPass substancePainterLookupPass { get => m_PostProcessPasses.substancePainterLookupPass; }
        internal PostProcessPass postProcessPass { get => m_PostProcessPasses.postProcessPass; }
        internal PostProcessPass finalPostProcessPass { get => m_PostProcessPasses.finalPostProcessPass; }
        internal RTHandle colorGradingLut { get => m_PostProcessPasses.colorGradingLut; }
        internal RTHandle bakeLookUpLut { get => m_PostProcessPasses.m_BakeLookUpLut; }
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (generateColorGradingLUT)
            {
                ...
                substancePainterLookupPass.ConfigureDescriptor(in renderingData.postProcessingData, out var desc1, out var filterMode1);
                RenderingUtils.ReAllocateIfNeeded(ref m_PostProcessPasses.m_BakeLookUpLut, desc, filterMode, TextureWrapMode.Clamp, anisoLevel: 0, name: "Grading Lut For Bake");
                substancePainterLookupPass.Setup(bakeLookUpLut);
                EnqueuePass(substancePainterLookupPass);
            }
