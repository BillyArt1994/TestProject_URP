...
#region Color Grading
        ...
        void SetupColorGrading(CommandBuffer cmd, ref RenderingData renderingData, Material material)
        {
            ...
            else
            {
                ...
                material.SetFloat("ACES_A", (float)m_Tonemapping.ACES_A);
                material.SetFloat("ACES_B", (float)m_Tonemapping.ACES_B);
                material.SetFloat("ACES_C", (float)m_Tonemapping.ACES_C);
                material.SetFloat("ACES_D", (float)m_Tonemapping.ACES_D);
                material.SetFloat("ACES_E", (float)m_Tonemapping.ACES_E);

                material.SetFloat("A", (float)m_Tonemapping.A);
                material.SetFloat("B", (float)m_Tonemapping.B);
                material.SetFloat("C", (float)m_Tonemapping.C);
                material.SetFloat("D", (float)m_Tonemapping.D);
                material.SetFloat("E", (float)m_Tonemapping.E);
                material.SetFloat("F", (float)m_Tonemapping.F);
                material.SetFloat("G", (float)m_Tonemapping.G);
                material.SetFloat("H", (float)m_Tonemapping.H);
            }
        }
