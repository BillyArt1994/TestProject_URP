...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class ColorGradingLutPass : ScriptableRenderPass
    {
        ...
        public static ColorGradingLutPass m_Instance;
        ...
        private static void ExecutePass(ScriptableRenderContext context, PassData passData, ref RenderingData renderingData, RTHandle internalLutTarget)
        {
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.ColorGradingLUT)))
            {
                ...
                ///FILM////////////////////////////////////////////////
                material.SetFloat("ACES_A", (float)tonemapping.ACES_A);
                material.SetFloat("ACES_B", (float)tonemapping.ACES_B);
                material.SetFloat("ACES_C", (float)tonemapping.ACES_C);
                material.SetFloat("ACES_D", (float)tonemapping.ACES_D);
                material.SetFloat("ACES_E", (float)tonemapping.ACES_E);
                //////////////////////////////////////////////////////

                ///FILM////////////////////////////////////////////////
                material.SetFloat("A", (float)tonemapping.A);
                material.SetFloat("B", (float)tonemapping.B);
                material.SetFloat("C", (float)tonemapping.C);
                material.SetFloat("D", (float)tonemapping.D);
                material.SetFloat("E", (float)tonemapping.E);
                material.SetFloat("F", (float)tonemapping.F);
                material.SetFloat("G", (float)tonemapping.G);
                material.SetFloat("H", (float)tonemapping.H);
                //////////////////////////////////////////////////////
                ...
                if (hdr)
                {
                    ...
                    switch (tonemapping.mode.value)
                    {
                        ...
                        /////////////////UE4_ACES_END/////////////////
                        case TonemappingMode.FILM: material.EnableKeyword(ShaderKeywordStrings.TonemapFilm); break;
                        case TonemappingMode.OverWatch2: material.EnableKeyword(ShaderKeywordStrings.TonemapOverWatch2); break;
                        default: break; // None
                    }
               ...
               // material.EnableKeyword("_LINEAR_INPUT_SRGB_OUTPUT");
                // Render the lut
               ...
               // var filepath = Application.dataPath + "/GradingLut.exr";
               // m_saveLutFlag = !File.Exists(filepath);
               //
               // if (m_saveLutFlag == true )
               // {
               //    
               //    // Blitter.BlitCameraTexture(cmd, internalLutTarget, internalLutTarget, RenderBufferLoadAction.DontCare, RenderBufferStoreAction.Store, material, 0);
               //     RenderTexture.active = internalLutTarget.rt;
               //     var tex2D = new Texture2D(internalLutTarget.rt.width, internalLutTarget.rt.height, TextureFormat.RGBAFloat, false);
               //     tex2D.ReadPixels(new Rect(0, 0, internalLutTarget.rt.width, internalLutTarget.rt.height), 0, 0);
               //     tex2D.Apply();
               //     byte[] bytes = tex2D.EncodeToEXR();
               //     File.WriteAllBytes(filepath, bytes);
               //     m_saveLutFlag =false;
               //     //material.DisableKeyword("_LINEAR_INPUT_SRGB_OUTPUT");
               // }
