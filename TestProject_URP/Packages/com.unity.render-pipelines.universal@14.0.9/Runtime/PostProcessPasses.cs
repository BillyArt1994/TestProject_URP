...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal struct PostProcessPasses : IDisposable
    {
        ...
        public SubstancePainterLookupPass substancePainterLookupPass { get => m_SubstancePainterLookupPass; }
        ...
        public PostProcessPasses(PostProcessData rendererPostProcessData, ref PostProcessParams postProcessParams)
        {
            ...
            m_SubstancePainterLookupPass = null;
        ...
        public void Recreate(PostProcessData data, ref PostProcessParams ppParams)
        {
            ...
            if (data != null)
            {
                ...
                //-----------------------Bake Lut Begin-----------------------
                m_SubstancePainterLookupPass = new SubstancePainterLookupPass(RenderPassEvent.BeforeRenderingPrePasses, data);
                //-----------------------Bake Lut End-------------------------
        ...
        public void Dispose()
        {
            ...
            m_ColorGradingLutPass?.Cleanup();
            m_SubstancePainterLookupPass?.Cleanup();
            m_PostProcessPass?.Cleanup();
            m_FinalPostProcessPass?.Cleanup();
            m_AfterPostProcessColor?.Release();
            m_ColorGradingLut?.Release();
            m_BakeLookUpLut?.Release();
        }
