...
{
    HLSLINCLUDE
        #pragma multi_compile_local _ _TONEMAP_ACES _TONEMAP_NEUTRAL _TONEMAP_UE4ACES _TONEMAP_FILM _TONEMAP_OVERWATCH2
        #pragma multi_compile_local_fragment _ HDR_COLORSPACE_CONVERSION
        #pragma multi_compile_local _ _LINEAR_INPUT_SRGB_OUTPUT
        ...
        float4 FragLutBuilderHdr(Varyings input) : SV_Target
        {
            ...
            #if _LINEAR_INPUT_SRGB_OUTPUT
            gradedColor = linear_to_sRGB(gradedColor);
            #endif
