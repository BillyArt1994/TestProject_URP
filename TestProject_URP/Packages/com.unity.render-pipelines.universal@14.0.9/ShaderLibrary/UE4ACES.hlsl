...
float3 OverWatch2(float3 x)
{
    ...
    // Step 2
    r1.xyz = B * r0.xyz + D;
    r2.xy = float2(F, G) * float2(E, E);
    r1.xyz = r0.xyz * r1.xyz + r2.yyy;
    r0.w = D * H;

    // Step 3
    r3.xyz = B * r0.xyz + r0.www;
    r0.xyz = r0.xyz * r3.xyz + r2.xxx;
