...
real3 ApplyLut2D(TEXTURE2D_PARAM(tex, samplerTex), float3 uvw, float3 scaleOffset)
{
 //Strip format where `height = sqrt(width)`
   ...
   //float4 r0 = float4(uvw,0.0);
   //float4 r1;
   // r0.yz = r0.yz*float2(30.0, 30.0) + float2(0.5, 0.5);
   // 
   // r0.x = r0.x * 31.0;
   //r0.w = floor(r0.x); //round_ni;
//
   //r0.x = frac(r0.x);
   //
//
   //r1.z = r0.w*0.03125 + 0.03125;
   //r1.x = r0.w * 0.03125;
   //r1.y = 0.0;
//
   // r1.zw = r0.yz*float2(0.001008, 0.032258) + r1.zy;
   // r0.yz = r0.yz*float2(0.001008, 0.032258) + r1.xy;
   // 
//
//
   // r0.yzw = SAMPLE_TEXTURE2D_LOD(tex,samplerTex, r0.yz,0.0).xyz ;//sample_state s0;
   // 
//
   // 
   // r1.xyz = SAMPLE_TEXTURE2D_LOD(tex,samplerTex, r1.zw,0.0).xyz; //sample_state s0;
   // 
//
