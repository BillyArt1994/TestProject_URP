...
public class Test
{
    [MenuItem("Assets/Create/Shader/URP Shader", false, 80)]
    public static void CreatNewLua()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
        ScriptableObject.CreateInstance<MyDoCreateScriptAsset>(),
        GetSelectedPathOrFallback() + "/New URP shader.shader",
        null,
       "Assets/Editor/URPShader/Template/CustomURPShader.Shader");
    }
